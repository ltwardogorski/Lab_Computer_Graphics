...
for i in range(0,6):
  LayerDense1 = keras.layers.Dense(150, activation=None, use_bias=True, kernel_initializer='glorot_uniform')
...
genderModel.fit(BazaImg, BazaAns, epochs=20, batch_size=4, shuffle=True)
